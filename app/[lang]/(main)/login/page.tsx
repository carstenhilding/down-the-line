...
export default function LoginPage({
  ...
  const handleLogin = async (e: FormEvent) => {
    ...
    try {
      ...
      if (firebaseError.code === 'auth/invalid-email' || firebaseError.code === 'auth/user-not-found' || firebaseError.code === 'auth/wrong-password' || firebaseError.code === 'auth/invalid-credential') {
