// i18n/main.ts - Til (main) området (offentlige sider, Header, Footer)
    ...
    pricing: {
      ...
      academy: {
          ...
          plans: [
              ...
              { name: "Elite", price: "Contact Us", mostPopular: "Most Popular", description: "The complete platform for professional organizations.", features: ["Everything in Performance, plus:", "Scouting & Talent ID Modul", "API Access", "Custom Integrations"], buttonText: "Contact Us" },
